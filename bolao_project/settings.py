...
SECRET_KEY = os.getenv(
    "SECRET_KEY",
    "django-insecure-95%=%7n40_=82!o=c9b#$s&4*kx$0sr0ofu%ipym21vq@ykq6i"
)
...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",  # <- falta isso
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "bolao_project" / "templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
